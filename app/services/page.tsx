              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="blog">Writing / Content Creation</option>
                    <option value="book">Editorial / Proofreading</option>
                    <option value="devotional">Creative Strategy Consulting</option>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="under-500">Under $100</option>
                    <option value="500-1000">$100 - $250</option>
                    <option value="1000-2500">$200 - $500</option>
                    <option value="2500-5000">$500 - $1,000</option>
                    <option value="over-5000">Over $1,000</option>
                  </select>
                </div>
